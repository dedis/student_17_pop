...
# Needs 4 clients
NBR=4
PACKAGE_POP_GO="github.com/dedis/student_17_pop/pop"
PACKAGE_POP="$GOPATH/src/$PACKAGE_POP_GO"
pop=`basename $PACKAGE_POP`
PACKAGE_IDEN="github.com/dedis/student_17_pop/identity"
...
main(){
    ...
    buildKeys
    buildConode gopkg.in/dedis/cothority.v1/cosi/service $PACKAGE_IDEN $PACKAGE_POP_GO/service
    build $PACKAGE_POP
    createFinal 2
    createToken 2
